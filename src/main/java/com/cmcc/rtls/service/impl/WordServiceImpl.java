...
import com.cmcc.rtls.model.ModelAttr;
import com.cmcc.rtls.model.Request;
import com.cmcc.rtls.model.Response;
import com.cmcc.rtls.model.Table;
...
public class WordServiceImpl implements WordService {
    ...
    public Map<String, Object> tableList(String swaggerUrl) {
        ...
        try {
            ...
            resultMap.put("basePath", map.get("basePath"));

            log.debug(JsonUtils.writeJsonStr(resultMap));
        } catch (Exception e) {
            resultMap.put("info", "null");
            resultMap.put("basePath", "null");
            resultMap.put("tableMap", "null");
        }
        return resultMap;
    }
